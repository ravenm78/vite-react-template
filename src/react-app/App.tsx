        ...
        <div className="heroStage" aria-label="Featured portfolio visual">
          <div className="heroImage">
            ...
            <div className="heroSelectors">
              <button className="selector selectorOne" aria-label="Hero visual selector one" />
              <button className="selector selectorTwo" aria-label="Hero visual selector two" />
              <button className="selector selectorThree isActive" aria-label="Hero visual selector three" />
              <button className="selector selectorFour" aria-label="Hero visual selector four" />
            </div>
